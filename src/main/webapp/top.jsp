                                        ...
                                        <nav class="main-nav">
                                                <div class="menu-top-menu-container">
                                                        <ul id="menu-top-menu" class="clearfix">
                                                                ...
                                                                <li class="current-menu-item"><a href="/post/top">置顶</a></li>
                                                ...
                                                <div id="pagination">
                                                        ...
                                                        <c:choose>
                                                                <c:when test="${pageNum==i}">
                                                                        <a href="/post/top/${i}" class="btn active">${i}</a>
                                                                </c:when>
                                                                <c:otherwise>
                                                                        <a href="/post/top/${i}" class="btn">${i}</a>
                                                                </c:otherwise>
                                                        </c:choose>
                                                        </c:forEach>
                                                        <c:choose>
                                                                ...
                                                                <c:otherwise>
                                                                        <a href="/post/top/${pageNum+1}" class="btn">Next »</a>
                                                                        <a href="/post/top/${pageTotal}" class="btn">Last »</a>
                                                                </c:otherwise>
                                                        </c:choose>
